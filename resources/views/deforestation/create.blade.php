    ...
    <div class=" mx-auto ">
        <div class="bg-stone-100/90 dark:bg-custom-gray  shadow-sm sm:rounded-2xl shadow-soft p-4 md:p-6 lg:p-6 mb-6">
            <div class="text-gray-900 dark:text-gray-100 ">
                <h3 class="text-2xl md:text-3xl font-black text-gray-900 mb-2 md:mb-2">
                            ...
                            <div class="flex flex-col items-end space-y-2">
                                ...
                                <div class="relative">
                                   <!-- Botón para formulario manual -->
                                    <button id="manual-polygon-toggle" title="Cordenadas Manuales" class="bg-gray-600 hover:bg-gray-700 text-white px-2 py-1 rounded-lg flex items-center shadow-lg">
