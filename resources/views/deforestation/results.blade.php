...
<div class="max-w-7xl mx-auto ">
    <div class="bg-stone-100/90 dark:bg-custom-gray overflow-hidden shadow-sm sm:rounded-2xl shadow-soft p-4 md:p-6 lg:p-8 mb-6">
        <div class="text-gray-900 dark:text-gray-100 ">
            <h2 class="font-semibold text-2xl leading-tight mb-6">
                Resultados del Análisis de: {{ $polygon->name }}
            </h2>

            <div class="flex flex-col lg:flex-row gap-6">
                <div class="w-full lg:w-8/12">
                    <!-- Gráfico de evolución -->
                    <div class="bg-white dark:bg-custom-gray3  rounded-xl shadow-md overflow-hidden mb-6 border border-gray-800">
